...
// @EventBusSubscriber(modid = VoidMachina.MODID, bus =
...
// @Override
// protected void apply(@Nonnull Map<ResourceLocation, JsonElement> data,
...
// } catch (Exception e) {
// VoidMachina.LOGGER.error("Failed to load VoidEnergy value for item {}",
// itemEntry.getKey(), e);
// }
// });
// }
...
// VoidEnergyRegistry.registerItemVoidEnergy(itemId, value);
// } catch (Exception e) {
// VoidMachina.LOGGER.error("Failed to load VoidEnergy value for tag {}",
// itemEntry.getKey(), e);
// }
// });
// }
